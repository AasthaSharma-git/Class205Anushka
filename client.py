...
def leftBoard():
    ...
    for box in range(0,11):
        if box==0:
            boxLabel=Label(gameWindow,font=("Helvetica",30),height=1,width=2,relief='ridge',borderwidth=0,bg='red')
            boxLabel.place(x=xPos,y=screen_height/2-88)
            leftBoxes.append(boxLabel)
            xPos+=55
        else:
            boxLabel=Label(gameWindow,font=("Helvetica",30),height=1,width=2,relief='ridge',borderwidth=0,bg='white')
            boxLabel.place(x=xPos,y=screen_height/2-88)
            leftBoxes.append(boxLabel)
            xPos+=55
...
def rightBoard():
    ...
    for box in range(0,11):
        if box==10:
            boxLabel=Label(gameWindow,font=("Helvetica",30),height=1,width=2,relief='ridge',borderwidth=0,bg='yellow')
            boxLabel.place(x=xPos,y=screen_height/2-88)
...
def gameWindow():
    ...
    dice = canvas2.create_text(screen_width/2 , screen_height/2 +
                               140, text="\u2680", font=("Chalkboard SE", 250), fill="white")
